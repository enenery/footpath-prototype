...
const userOneStepSize = 15; //user's one step size 15 px = 30 inches = ~70 cm
...
//make a random map
POLYGON1.pathPoints = [new Point(50, 100), new Point(100, 100), new Point(100, 97), new Point(130, 97), new Point(130, 100),
						new Point(200, 100), new Point(200, 60), new Point(230, 60), new Point(230, 100), new Point(250, 100),
						new Point(250, 97), new Point(280, 97), new Point(280, 100), new Point(500, 100), new Point(500, 60),
						new Point(550, 60), new Point(550, 130), new Point(553, 130), new Point(553, 150), new Point(550, 150),
						new Point(550, 150), new Point(550, 200), new Point(553, 200), new Point(553, 220), new Point(550, 220),
						new Point(550, 240), new Point(600, 240), new Point(600, 270), new Point(550, 270), new Point(550, 400), 
						new Point(600, 400), new Point(600, 350), new Point(630, 350), new Point(630, 400),
						new Point(700, 400), new Point(700, 430), new Point(703, 430), new Point(703, 480), new Point(700, 480),
						new Point(700, 500), new Point(703, 500), new Point(703, 550), new Point(700, 550),
						new Point(700, 580), new Point(400, 580), new Point(400, 300), new Point(50, 300)];
...
//make user's path for the random map
while(x <= 535){
	PATH1.addPoint(new Point(x, startOfY));
	x += userOneStepSize;
}
...
while(y <= 415){
	PATH1.addPoint(new Point(535, y));
	y += userOneStepSize;
}

while(x <= 685){
	PATH1.addPoint(new Point(x, 415));
	x += userOneStepSize;
}

y = 415;
while(y <= 530){
	PATH1.addPoint(new Point(685, y));
	y += userOneStepSize;
}
